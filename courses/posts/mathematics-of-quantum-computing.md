...
## Core Flow
This course builds quantum computing from the mathematical side:

- **Hilbert space formalism** gives states, amplitudes, measurement, and unitary evolution.
- **Projective geometry** explains why physical states are rays and why qubits live on the Bloch sphere.
- **Lie groups and Lie algebras** describe rotations, spin, generators, and continuous gates.
- **Representation theory of $SU(2)$ / $\mathfrak{sl}(2)$** organizes angular momentum, spin bases, and tensor-product decomposition.
- **Tensor, dual, exact, and categorical structures** provide the algebraic language for composite quantum systems.

The recurring theme is that quantum computation is not just linear algebra on $\mathbb C^2$; it is a synthesis of

$$
\text{Hilbert space} \;+\; \text{projective geometry} \;+\; \text{Lie theory} \;+\; \text{representation theory}.
$$